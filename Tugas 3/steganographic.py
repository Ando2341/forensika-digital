...
def create_steganographic_pdf(pdf_file, output_pdf, logo_file):
    ...
    with open(pdf_file, 'rb') as file:
        ...
        c = canvas.Canvas("output/logo_page.pdf", pagesize=letter)
        ...
        c.save()
        with open("output/logo_page.pdf", 'rb') as logo_page_file:
        ...
        c = canvas.Canvas("output/metadata_page.pdf", pagesize=letter)
        c.setFillColorRGB(1, 1, 1)  # Set text color to white
        c.drawString(100, 100, metadata_data_encoded)
        c.save()
        with open("output/metadata_page.pdf", 'rb') as metadata_file:
...
output_pdf = "output/encoded_jurnal.pdf"
logo_file = "logo.png"
